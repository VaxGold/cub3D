...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/09 18:07:08 by omercade          #+#    #+#             */
/*   Updated: 2021/04/14 18:23:53 by omercade         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	raycast_draw(t_raycast *ryc, t_data *gd, t_render *render, int x)
{
	...
	p.x = x;
	p.y = 0;
	color_fill(gd, render->drawStart, p, gd->color[0]);
	...
	p.y = render->drawEnd;
	color_fill(gd, gd->cnv.h, p, gd->color[1]);
}
